...
from view.Ui_planification_information import Form
...
class PlanificationWidgetInformation(QWidget):
    ...
    def aplicar_tema(self, tema):
        ...
        if tema == "dark_theme":
            ruta_estilo = os.path.join(ruta_base, "..", "view", "styles", "dark_theme","planification_information.qss")
        elif tema == "light_theme":
            ruta_estilo = os.path.join(ruta_base, "..", "view", "styles", "light_theme","planification_information.qss")
        else:
